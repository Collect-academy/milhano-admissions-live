...
export function ManualEodSummary({
  ...
  const funnel = [
    ...
    },
    {
      ...
      helper: tr(locale, "Detailed by contact in EOD", "Detalle por contacto en EOD"),
    ...
    },
    {
      ...
      helper: tr(locale, "Show outcomes", "Outcomes Show"),
    ...
    },
    {
      ...
      helper: tr(locale, "Closed outcomes", "Outcomes Closed"),
