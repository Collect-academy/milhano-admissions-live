  ...
  if(embed){
    return <main className={styles.embedWrap}>
      <div className={styles.embedHead}>
        ...
        <div><div className={styles.tag}>After School Experience</div><b>Reserva tu taller</b></div>
      </div>
  ...
  return <main className={styles.wrap}>
    <div className={styles.shell}>
      ...
      <section className={styles.hero}>
        ...
        <p>Registra de 1 a 4 alumnos. Cada pase de <b>$50 MXN</b> corresponde a <b>un taller por participante</b>. Los talleres con 20 registros dejan de mostrarse automáticamente.</p>
      </section>
      <RegistrationForm/>
    </div>
  </main>
